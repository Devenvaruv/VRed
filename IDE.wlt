...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 1
      ...
      index: 0
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-296.79998779296877,"y":0.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":1,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -296.8, y: 0}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 1
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-147.699951171875,"y":86.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":1,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -147.69995, y: 86}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 1
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":-254.80101013183595,"y":-184.80101013183595},"m_SnapOffsetDelta":{"x":-0.0000152587890625,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":250.40000915527345,"y":180.0},"m_SizeOverridden":true}'
      floating: 1
      collapsed: 0
      snapOffset: {x: -254.80101, y: -184.80101}
      snapOffsetDelta: {x: -0.000015258789, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 250.40001, y: 180}
      sizeOverridden: 1
    - dockPosition: 1
      containerId: overlay-container--right
      displayed: 0
    ...
    - containerId: Floating
      scrollOffset: 0
    m_OverlaysVisible: 1
  m_WindowGUID: f98c629654515e34c8500036083aab95
  m_Gizmos: 1
  ...
  m_Position:
    m_Target: {x: 22.36669, y: 0.97000027, z: 1.0515593}
    speed: 2
    m_Value: {x: 22.366686, y: 0.9699979, z: 1.0515567}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0, y: 0.70710677, z: -0, w: 0.7071068}
    speed: 2
    m_Value: {x: 0, y: 0.70710677, z: 0, w: 0.7071068}
  m_Size:
    m_Target: 0.65840393
    speed: 2
    m_Value: 0.6579105
...
MonoBehaviour:
  ...
  m_LastProjectPath: C:\Users\varud\Documents\My Web Sites\My project (2)
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    m_SelectedIDs: faed0000
    m_LastClickedID: 60922
    m_ExpandedIDs: 00000000faed0000fced0000ffffff7f
    m_RenameOverlay:
  ...
  m_AssetTreeState:
    ...
    m_CreateAssetUtility:
      ...
      m_ResourceFile: 
  m_ListAreaState:
    m_SelectedInstanceIDs: 1afbffff
    m_LastClickedInstanceID: -1254
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      scrollPos: {x: 0, y: 71}
      m_SelectedIDs: 7a78feff
      m_LastClickedID: -100230
      m_ExpandedIDs: 026efeff1afbffff42fbffff3c210300be2203004c230300
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: Pivot
        m_OriginalName: Pivot
        m_EditFieldRect:
          serializedVersion: 2
          x: 0
          y: 0
